...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        txt_file.write(voters_results)

         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (voters > largest_county) and (voters_percentage > largest_voter_turnout):
            largest_voter_turnout = voters_percentage
            largest_county = voters
